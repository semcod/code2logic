...
class TestTemplate:
    ...
    def render_function_test(
        ...
        if class_name:
            ...
            if param_values:
                lines.append(
                    f"    # result = {await_prefix}instance.{func_name}({', '.join(param_values)})"
                )
            else:
    ...
    def render_dataclass_test(self, class_name: str, fields: List[dict]) -> str:
        ...
        lines.append('        """Test dataclass fields are accessible."""')
        lines.append(f"        # instance = {class_name}(...)")
        ...
        lines.append('        """Test dataclass equality comparison."""')
